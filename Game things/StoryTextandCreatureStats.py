...
startText = ["You wake up after a long night's rest, startled by the dream you just had.",
            "[color=playerColor]\"What, or, more importantly, who was that voice?\" [color=white]you say,[color=playerColor] \"Curses? A quest?\"",
            "You get up, and look at yourself in the mirror.",
            "[color=playerColor]\"Me,{}? Why would I be the person to do this? There are [color=lighter playerColor]WAY[color=playerColor] more capable",
...
kidnappedText = ["...", "." * 6, "." * 9, "." * 12,
                ...
                "[color=white]You hear the sound of someone being forcefully kicked of the side of what",
                "[color=white]seems to be a bridge.",
                "[color=darker red]ThE iRoNiC tHiNg Is ThAt We HaVe JuSt ArRiVeD aT OuR DeStInAtIoN.",
                "[color=white]You hear a voice welcoming you to [color=dark red]\"PaUiRtGdY\"[/color][color=white]."]
pauirtgdyText = ["When you wake up, you are in, what seems to be, a royal palace.",
                ...
                "You tell the creature that is it[color=playerColor]{}.",
                "[color=light orange]So,{}, sOrRy fOr, YoU kNoW, kIdNaPpInG yOu AnD aLl.",
                "[color=light orange]HoW aBoUt ThIs? We FiGhT, aNd If YoU wIn, YoU gO fReE.",
                "[color=playerColor]\"What happens if you win?\"", "[color=light orange]YoU dIe.",
